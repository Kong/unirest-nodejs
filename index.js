    ...
    var $this = {
       ...
       */
        ...
        function handleRequestResponse (error, response, body) {
          ...
          result.resetContent = 205 == status;
          ...
          result.seeOther = 303 == status;
          result.notModified = 304 == status;
          result.useProxy = 305 == status;
          result.temporaryRedirect = 307 == status;
          result.permanentRedirect = 308 == status;
          ...
          result.uriTooLong = 414 == status;
          result.unsupportedMediaType = 415 == status;
          result.rangeNotSatisfiable = 416 == status;
          result.expectationFailed = 417 == status;
          result.misdirectedRequest = 421 == status;
          ...
          result.preconditionRequired = 428 == status;
          result.tooManyRequests = 429 == status;
          result.requestHeaderFieldsTooLarge = 431 == status;
          result.internalServerError = 500 == status;
          result.notImplemented = 501 == status;
          result.badGateway = 502 == status;
          result.serviceUnavailable = 503 == status;
          result.gatewayTimeout = 504 == status;
          result.httpVersionNotSupported = 505 == status;
          result.variantAlsoNegotiates = 506 == status;
          result.insufficientStorage = 507 == status;
          result.loopDetected = 508 == status;
          result.notExtended = 510 == status;
